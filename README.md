...
- **A-Frame Team**: For the amazing WebXR framework
- **MindAR**: For the powerful image tracking library
- **Three.js**: For the 3D rendering engine
- **Environmental Educators**: For inspiration on waste segregation education

## 📞 Contact & Support

- **GitHub**: [@Winskiii](https://github.com/Winskiii)
- **Repository**: [Bin](https://github.com/Winskiii/Bin)
- **Issues**: [Report bugs or request features](https://github.com/Winskiii/Bin/issues)

## 🗺️ Roadmap

- [ ] Add more trash categories (e-waste, glass, metal)
- [ ] Multiplayer mode with leaderboards
- [ ] Sound effects and background music
- [ ] Advanced animations and particle effects
- [ ] Location-based AR (markerless tracking)
